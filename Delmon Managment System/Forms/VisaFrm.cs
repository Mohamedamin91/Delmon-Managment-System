      ...
      ,[ID_Number]
       FROM [DelmonGroupDB].[dbo].[VISA], [Companies] where Companies.COMPID=VISA.ComapnyID and VisaNumber =  '" + VisaNumberID + "'";
        ...
        private void cmbConsulate_DropDown(object sender, EventArgs e)
        {
            ...
            string query3 = "select Consulates.ConsulateID,ConsulateCity from Countries,Consulates where Countries.CountryId = Consulates.CountryId order by ConsulateCity";
